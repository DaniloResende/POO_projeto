...
public:
   ...
   void Emprestar(vector<Livro *> livros, Usuario *usuario, string data);//empresta livro(s). O(s) livro(s) emprestado(s) passa/passam para status de emprestado e o usuario passa a ter o(s) livro(s) em seu historico de livros adquiridos da biblioteca. 
   void Devolucao(vector<Livro *> livros_emprest, Usuario *usuario, string data);//Status do(s) livro(s) deixa/ deixam de ser emprestado e o usuario deixa de ter aquele(s) livro(s) em seu historico
...
public:
   ...
   void UpdateUser(Usuario usuario);
   void DeleteUser(Usuario *usuario);
   void Emprestar(vector<Livro *> livros, Usuario *usuario);//empresta livro(s). O(s) livro(s) emprestado(s) passa/passam para status de emprestado e o usuario passa a ter o(s) livro(s) em seu historico de livros adquiridos da biblioteca. 
